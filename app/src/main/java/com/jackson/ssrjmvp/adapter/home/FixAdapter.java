 ...
 *          since 2018 07 19
 */
public class FixAdapter extends BaseDelegateAdapter<String, BaseViewHolder> {
     ...
     * @param viewTypeItem
     */
    public FixAdapter(Context context, List<String> list, LayoutHelper layoutHelper, int lauoutId, int count, int viewTypeItem) {
